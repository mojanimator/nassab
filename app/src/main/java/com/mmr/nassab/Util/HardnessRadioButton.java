...
public class HardnessRadioButton extends LinearLayout implements RadioCheckable {
    ...
    public HardnessRadioButton(Context context) {
        super(context);
        this.ctx = context;
        setupView();
    ...
    public HardnessRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.ctx = context;
    ...
    public HardnessRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public HardnessRadioButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        tvCount.setText(mCount);
    ...
    public void setCheckedState() {
        switch (status) {
            case "1":
                setBackgroundResource(R.drawable.ic_hardness_1);
                break;

            case "2":
                setBackgroundResource(R.drawable.ic_hardness_2);
                break;
        }
    ...
    public void setNormalState() {
        switch (status) {
            case "1":
                setBackgroundResource(R.drawable.ic_hardness_1_deactive);
                break;

            case "2":
                setBackgroundResource(R.drawable.ic_hardness_2_deactive);
                break;
        }
